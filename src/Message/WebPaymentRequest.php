...
class WebPaymentRequest extends AbstractRequest
{
    ...
    public function getData()
    {
        ...
        return new \SquareConnect\Model\CreateCheckoutRequest([
            ...
            'note'=>!empty($_SERVER['square_note']) ? (bool) $_SERVER['square_note'] : false,
            'ask_for_shipping_address' => !empty($_SERVER['square_ask_for_shipping_address']) ? (bool) $_SERVER['square_ask_for_shipping_address'] : false,
